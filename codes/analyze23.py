...
print("ryan vs brad jaccard distance")
print(numpy.count_nonzero(bc_mat-rma_mat)/numpy.count_nonzero(bc_mat+rma_mat))
print("ryan vs computer jaccard distance")
print(numpy.count_nonzero(cl_mat-rma_mat)/numpy.count_nonzero(cl_mat+rma_mat))
print("brad vs computer jaccard distance")
print(numpy.count_nonzero(cl_mat-bc_mat)/numpy.count_nonzero(cl_mat+bc_mat))