...
M = [[len(set(sl) & set(cw)) for cw in cluster_words ] for sl in selected_lemmas]
...
rma_mat = numpy.zeros((len(words),len(words)))
bc_mat = numpy.zeros((len(words),len(words)))
cl_mat = numpy.zeros((len(words),len(words)))

n = len(rma_sents)

bc_cat = [set()]*len(bc_cats_set)
rma_cat = [set()]*len(rma_cats_set)

for i in range(n):
    bc_cat_index = bc_cats_set.index(bc_cats[i])
    bc_cat[bc_cat_index] = (bc_cat[bc_cat_index] | set(bc_sents[i])) & set(words)
    rma_cat_index = rma_cats_set.index(rma_cats[i])
    rma_cat[rma_cat_index] = (rma_cat[rma_cat_index] | set(rma_sents[i])) & set(words)
...
print("number of word couples brad clustered together : ",end = "")
print(numpy.count_nonzero(bc_mat))
print("number of word couples ryan clustered together : ",end = "")
print(numpy.count_nonzero(rma_mat))
print("number of word couples computer clustered together : ",end = "")
print(numpy.count_nonzero(cl_mat))
print("")

print("number of word couples ryan and brad clustered the same way : ",end = "")
print(numpy.count_nonzero(bc_mat==rma_mat))
print("number of word couples ryan and brad did not clustered  the same way : ",end = "")
print(numpy.count_nonzero(bc_mat!=rma_mat))
print("")
