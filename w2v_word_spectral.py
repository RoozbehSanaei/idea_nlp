...
def w2v_word_spectral( similarity_matrix,words,selected_lemmas,s,p):
	n = len(words)

	labels = spectral_cluster(similarity_matrix,p)
...
#    N = numpy.zeros(400)
	...
	costs_ = costs (labels,similarity_matrix)
