...
similarities = ['lda_similarity','vec_similairy','skipthoughts_similarity','num_word_similarity','total_set_similairy','max_set_similairy']
similarities = ['lda_similarity']
files = ['n1400_dn']
clusterings_algs = ["spectralـnearest_neighbors","spectralـprecomputed","spectralـrbf","spectralـsigmoid","spectralـpolynomial","spectralـpoly","spectralـlinear","agglomerative_clustering","affinity_propagation","kmeans","birch","ward_clustering"]
