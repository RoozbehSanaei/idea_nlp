...
#-----------------------------------------------------------------------------#
path_to_models = '/home/roozbeh/data/wiki/skip-thoughts/'
path_to_tables = '/home/roozbeh/data/wiki/skip-thoughts/'
#-----------------------------------------------------------------------------#
...
def load_tables():
    ...
    """
    words = []
    utable = numpy.load(path_to_tables + 'utable.npy', fix_imports=True,encoding = 'latin1')
    btable = numpy.load(path_to_tables + 'btable.npy', fix_imports=True,encoding = 'latin1')
